...
def create_grid(x,y,shape,x_error=[[None]],y_error=[[None]],
    ...
    if auto_axis == True:
        axis_range = laplt.determine_axis(x[0],y[0])
...
mpl.rcParams['xtick.labelsize'] = 12        # Size of x-tick labels
mpl.rcParams['ytick.labelsize'] = 12        # Size of y-tick labels
mpl.rcParams['axes.labelsize'] = 14         # Size of axes labels
mpl.rcParams['image.origin'] = 'lower'      # 

mpl.rcParams['axes.linewidth'] = 2.0        # Size of axes line width
mpl.rcParams['xtick.major.size'] = 12      # Size of major x-ticks
mpl.rcParams['xtick.minor.size'] = 5        # Size of minor x-ticks
mpl.rcParams['xtick.major.width'] = 2.0     # Width of major x-ticks
mpl.rcParams['xtick.minor.width'] = 1.0     # Width of minor x-ticks
mpl.rcParams['ytick.major.size'] = 12       # Size of major y-ticks
mpl.rcParams['ytick.minor.size'] = 5        # Size of minor y-ticks
mpl.rcParams['ytick.major.width'] = 2.0     # Width of major y-ticks
mpl.rcParams['ytick.minor.width'] = 1.0     # Width of minor y-ticks
