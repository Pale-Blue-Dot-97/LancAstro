...
def convert_to_array(var):
    ...
    if isinstance(var,(list,tuple,np.ndarray)) == False or isinstance(var,str) == True:
        var = [var]
...
def plot(ax,x,y,z,DATALABELS=[None],COLOURS=[None],SIZES=[2],
         POINTSTYLES=['none'],CMAP=[None]):
    ...
    z = convert_to_array(z)
    """
    if isinstance(x[0],(list,np.ndarray)) == False: x = [x]
    if isinstance(y[0],(list,np.ndarray)) == False: y = [y]
    if isinstance(z[0],(list,np.ndarray)) == False: z = [z]
    ...
    for i in range(len(x)):
        ...
        if COLOURS[i] == 'colourbar' and CMAP[i] != None:
            c = np.array(z[i])
...
def create_figure(x,y,z,DATALABELS=[None],COLOURS=[None],CMAP=[None],
                  SIZES=[2],POINTSTYLES=['none'],figure_name="Plot3D_fig.pdf",
                  x_label=None,y_label=None,z_label=None,figsize=(10.,10.),
                  axis_range=[0.0,10.0,0.0,10.0],txt_labels=[[None]],
                  x_ticks=None,x_tick_labels=None,y_ticks=None,
                  y_tick_labels=None,z_ticks=None,z_tick_labels=None,
                  label_rot=[20.0,340.0,90.0],elev=10.,azim=60.):
...
def create_visualisation(x,y,z,DATALABELS=[None],COLOURS=[None],CMAP=[None],
                        SIZES=[2],POINTSTYLES=['none'],x_label=None,
                        y_label=None,z_label=None,figure_name="Plot3D_fig.pdf",
                        figsize=(10.,10.),axis_range=[0.0,10.0,0.0,10.0],
                        txt_labels=[[None]],x_ticks=None,x_tick_labels=None,
                        y_ticks=None,y_tick_labels=None,z_ticks=None,
                        z_tick_labels=None,label_rot=[20.0,340.0,90.0],
                        elev=None,azim=None,no_frames=20,folder='Frames'):
    """ Creates a figure (or multiple figures) of the plots of data supplied
...
visible_axes = True        # Sets visibility of axes
